...
export const requestDeviceImpl = (just) => (nothing) => (adapter) => (options) => () => adapter.requestDevice(options).then((o) => (o ? just(o) : nothing));
export const requestAdapterInfoImpl = (adapter) => (unmaskHints) => () => adapter.requestAdapterInfo(unmaskHints);
