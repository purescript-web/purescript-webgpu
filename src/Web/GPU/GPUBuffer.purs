...
foreign import mapAsyncWithOffsetImpl :: GPUBuffer -> GPUMapMode -> GPUSize64 -> Effect (Promise Unit)

mapAsyncWithOffset :: GPUBuffer -> GPUMapMode -> GPUSize64 -> Effect (Promise Unit)
mapAsyncWithOffset = mapAsyncWithOffsetImpl

foreign import mapAsyncWithSizeImpl :: GPUBuffer -> GPUMapMode -> GPUSize64 -> Effect (Promise Unit)

mapAsyncWithSize :: GPUBuffer -> GPUMapMode -> GPUSize64 -> Effect (Promise Unit)
mapAsyncWithSize = mapAsyncWithSizeImpl

foreign import mapAsyncWithOffsetAndSizeImpl :: GPUBuffer -> GPUMapMode -> GPUSize64 -> GPUSize64 -> Effect (Promise Unit)

mapAsyncWithOffsetAndSize :: GPUBuffer -> GPUMapMode -> GPUSize64 -> GPUSize64 -> Effect (Promise Unit)
...
foreign import getMappedRangeWithOffsetImpl :: GPUBuffer -> GPUSize64 -> Effect ArrayBuffer

getMappedRangeWithOffset :: GPUBuffer -> GPUSize64 -> Effect ArrayBuffer
getMappedRangeWithOffset = getMappedRangeWithOffsetImpl

foreign import getMappedRangeWithSizeImpl :: GPUBuffer -> GPUSize64 -> Effect ArrayBuffer

getMappedRangeWithSize :: GPUBuffer -> GPUSize64 -> Effect ArrayBuffer
getMappedRangeWithSize = getMappedRangeWithSizeImpl

foreign import getMappedRangeWithOffsetAndSizeImpl :: GPUBuffer -> GPUSize64 -> GPUSize64 -> Effect ArrayBuffer

getMappedRangeWithOffsetAndSize :: GPUBuffer -> GPUSize64 -> GPUSize64 -> Effect ArrayBuffer
